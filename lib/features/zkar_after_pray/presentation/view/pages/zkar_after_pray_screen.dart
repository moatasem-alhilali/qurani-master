  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BaseHomeWidget(
        ...
        body: BlocBuilder<ZkarAfterPrayBloc, ZkarAfterPrayState>(
          builder: (context, state) {
            return state.state.handle<ZkarAfterPrayModel>(
              onSuccess: () {
              ...
              context: context,
              onRefresh: () {
                context.read<ZkarAfterPrayBloc>().add(LoadZkarAfterPrayEvent());
              },
