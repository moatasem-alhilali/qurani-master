...
Future<void> registerRadioDependencies(GetIt getIt) async {
  getIt
    ...
    ..registerLazySingleton<RadioFavouritesStore>(
      () => RadioFavouritesStore(getIt<CacheService>()),
    )
    ..registerLazySingleton<RadioSleepTimer>(RadioSleepTimer.new)
    ..registerLazySingleton<RadioRepository>(
      () => RadioRepository(
        localDataSource: getIt<RadioLocalDataSource>(),
        audioService: getIt<RadioAudioService>(),
        favourites: getIt<RadioFavouritesStore>(),
        sleepTimer: getIt<RadioSleepTimer>(),
      ),
    )
