...
List<TimePrayerModel> prayerData = [
  TimePrayerModel(
    ...
    color: Colors.white,
    time: sl.get<PrayerTimesRepo>().prayerTimeList[0].time12Hour,
    title: "الفجر",
    content: '''
...
''',
  ...
  TimePrayerModel(
    ...
    time: sl.get<PrayerTimesRepo>().prayerTimeList[1].time12Hour,
    title: "الشروق",
    content: '''
...
''',
  ...
  TimePrayerModel(
    ...
    time: sl.get<PrayerTimesRepo>().prayerTimeList[2].time12Hour,
    title: "الظهر",
    content: '''
...
''',
  ...
  TimePrayerModel(
    ...
    time: sl.get<PrayerTimesRepo>().prayerTimeList[3].time12Hour,
    title: "العصر",
    content: '''
...
''',
  ...
  TimePrayerModel(
    ...
    time: sl.get<PrayerTimesRepo>().prayerTimeList[4].time12Hour,
    title: "المغرب",
    content: '''
...
''',
  ...
  TimePrayerModel(
    ...
    time: sl.get<PrayerTimesRepo>().prayerTimeList[5].time12Hour,
    title: "العشاء",
    content: '''
