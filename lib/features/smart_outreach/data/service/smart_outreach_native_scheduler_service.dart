...
class SmartOutreachNativeSchedulerService {
  ...
  Future<void> scheduleGroup(SmartOutreachScheduleModel schedule) async {
    if (!Platform.isAndroid || schedule.id == null) {
      return;
    }
  ...
  Future<void> triggerGroupNow(int scheduleId) async {
    if (!Platform.isAndroid) {
      return;
    }
