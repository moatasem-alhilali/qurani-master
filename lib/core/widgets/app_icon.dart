...
class AppIcon extends StatelessWidget {
  ...
  /// معامل تعويض حشو HugeIcons الداخلي.
  ///
  /// أيقونات الحزمة مرسومة داخل إطار ‎24×24‎ لكن خطوطها تشغل نحو ‎19.5‎ وحدة
  /// منه فقط، فالباقي حشو مدمج في بيانات المسار لا يمكن نزعه. النتيجة أن
  /// `size: 16` يظهر بصريًا بنحو ‎13‎، فتبدو الأيقونة ضائعة داخل مربّعها.
  ///
  /// ‎24 ÷ 19.5 ≈ 1.23‎ — نعوّض هنا مرّة واحدة بدل تكبير الرقم يدويًا في كل
  /// نداء عبر التطبيق.
  static const _glyphCompensation = 1.23;

  @override
  Widget build(BuildContext context) {
    // [size] تعني الحجم البصري للأيقونة، لا حجم الصندوق ولا إطار المسار.
    //
    // كانت الحسبة الأصلية تقتطع فوق ذلك حشوًا ‎~18٪‎ من كل جانب، فتجتمع
    // الخسارتان: `size: 20` كان يرسم خطوطًا بعرض ‎10‎ تقريبًا — نصف المطلوب.
    final glyphSize = (size ?? 18.sp) * _glyphCompensation;
